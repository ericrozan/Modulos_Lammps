...
#include <stdlib.h>
#include <string.h>
#include "pair_panic_table_couples.h"
#include "atom.h"
#include "force.h"
#include "comm.h"
...
PairPanicTableCouples::PairPanicTableCouples(LAMMPS *lmp) : Pair(lmp)
{
  ntables = 0;
  tables = NULL;
}
...
PairPanicTableCouples::~PairPanicTableCouples()
{
  if (copymode) return;
...
void PairPanicTableCouples::allocate()
{
  allocated = 1;
...
void PairPanicTableCouples::coeff(int narg, char **arg)
{
...
double PairPanicTableCouples::init_one(int i, int j)
{
...
void PairPanicTableCouples::read_table(Table *tb, char *file, char *keyword)
{
  char line[MAXLINE];
...
void PairPanicTableCouples::bcast_table(Table *tb)
{
...
void PairPanicTableCouples::spline_table(Table *tb)
{
...
void PairPanicTableCouples::param_extract(Table *tb, char *line)
{
  tb->ninput = 0;
  tb->rflag = NONE;
  tb->fpflag = 0;
...
void PairPanicTableCouples::compute_table(Table *tb)
{
  int tlm1 = tablength-1;
...
void PairPanicTableCouples::null_table(Table *tb)
{
...
void PairPanicTableCouples::free_table(Table *tb)
{
...
void PairPanicTableCouples::spline(double *x, double *y, int n,
...
double PairPanicTableCouples::splint(double *xa, double *ya, double *y2a, int n, double x)
{
  int klo,khi,k;
  double h,b,a,y;
...
void PairPanicTableCouples::write_restart(FILE *fp)
{
...
void PairPanicTableCouples::read_restart(FILE *fp)
{
...
void PairPanicTableCouples::write_restart_settings(FILE *fp)
{
...
void PairPanicTableCouples::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairPanicTableCouples::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairPanicTableCouples::extract(const char *str, int &dim)
{
...
void PairPanicTableCouples::wall_extract(Table *tb, char *line,FILE *fp)
{
  int  i,n;
  char word[MAXLINE];
