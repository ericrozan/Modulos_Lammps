...
PairStyle(panic/table/diam/distribution,PairPanicTableDiamDistribution)

#else

#ifndef LMP_PAIR_PANIC_TABLE_DIAM_DISTRIBUTION_H
#define LMP_PAIR_PANIC_TABLE_DIAM_DISTRIBUTION_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableDiamDistribution : public Pair {
 public:
  PairPanicTableDiamDistribution(class LAMMPS *);
  virtual ~PairPanicTableDiamDistribution();
