...
PairStyle(panic/table/couples,PairPanicTableCouples)

#else

#ifndef LMP_PAIR_PANIC_TABLE_COUPLES_H
#define LMP_PAIR_PANIC_TABLE_COUPLES_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableCouples : public Pair {
 public:
  PairPanicTableCouples(class LAMMPS *);
  virtual ~PairPanicTableCouples();
